...
clear all
%--CHANGE PATH HERE--%
datadir = '/Users/u2096377/Documents/PhD/ModellingRatingsTutorial_LabMeeting_06122024';
%---%
cd(datadir)
...
% Give the model id and a title
i_model = 2; %ID
model_titles{i_model} = 'RfRr'; %Title
% How many parameters are in the model?
model_params(i_model) = 2;
...
%% VII. Compare the models for each participant
% Determine the winning (lowest AIC/BIC) model for each individual participant. 

n_models = i_model; %How many models to compare
...
best_AIC_sum_model_title = model_titles(best_AIC_sum_model); %The name of the model with the best overall AIC sum score
